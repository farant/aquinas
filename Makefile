...
KERNEL_C_SRCS = $(KERNEL_DIR)/kernel.c $(KERNEL_DIR)/serial.c $(KERNEL_DIR)/vga.c $(KERNEL_DIR)/timer.c $(KERNEL_DIR)/rtc.c $(KERNEL_DIR)/memory.c $(KERNEL_DIR)/graphics.c $(KERNEL_DIR)/dispi.c $(KERNEL_DIR)/display_driver.c $(KERNEL_DIR)/pci.c $(KERNEL_DIR)/dispi_cursor.c $(KERNEL_DIR)/grid.c $(KERNEL_DIR)/graphics_context.c $(KERNEL_DIR)/page.c $(KERNEL_DIR)/modes.c $(KERNEL_DIR)/display.c $(KERNEL_DIR)/commands.c
