...
KERNEL_C_SRCS = $(KERNEL_DIR)/kernel.c $(KERNEL_DIR)/serial.c $(KERNEL_DIR)/vga.c $(KERNEL_DIR)/timer.c $(KERNEL_DIR)/rtc.c $(KERNEL_DIR)/memory.c $(KERNEL_DIR)/graphics.c $(KERNEL_DIR)/dispi.c $(KERNEL_DIR)/display_driver.c $(KERNEL_DIR)/pci.c $(KERNEL_DIR)/dispi_cursor.c $(KERNEL_DIR)/grid.c $(KERNEL_DIR)/graphics_context.c $(KERNEL_DIR)/page.c $(KERNEL_DIR)/modes.c $(KERNEL_DIR)/display.c $(KERNEL_DIR)/commands.c $(KERNEL_DIR)/editor.c $(KERNEL_DIR)/input.c $(KERNEL_DIR)/mouse.c $(KERNEL_DIR)/dispi_init.c $(KERNEL_DIR)/dispi_demo.c $(KERNEL_DIR)/view.c $(KERNEL_DIR)/layout.c $(KERNEL_DIR)/layout_demo.c $(KERNEL_DIR)/ui_button.c $(KERNEL_DIR)/ui_label.c $(KERNEL_DIR)/ui_panel.c $(KERNEL_DIR)/ui_textinput.c $(KERNEL_DIR)/ui_textarea.c $(KERNEL_DIR)/ui_demo.c

# Build files
BOOT_BIN = $(BUILD_DIR)/boot.bin
KERNEL_ENTRY_OBJ = $(BUILD_DIR)/kernel_entry.o
KERNEL_C_OBJS = $(BUILD_DIR)/kernel.o $(BUILD_DIR)/serial.o $(BUILD_DIR)/vga.o $(BUILD_DIR)/timer.o $(BUILD_DIR)/rtc.o $(BUILD_DIR)/memory.o $(BUILD_DIR)/graphics.o $(BUILD_DIR)/dispi.o $(BUILD_DIR)/display_driver.o $(BUILD_DIR)/pci.o $(BUILD_DIR)/dispi_cursor.o $(BUILD_DIR)/grid.o $(BUILD_DIR)/graphics_context.o $(BUILD_DIR)/page.o $(BUILD_DIR)/modes.o $(BUILD_DIR)/display.o $(BUILD_DIR)/commands.o $(BUILD_DIR)/editor.o $(BUILD_DIR)/input.o $(BUILD_DIR)/mouse.o $(BUILD_DIR)/dispi_init.o $(BUILD_DIR)/dispi_demo.o $(BUILD_DIR)/view.o $(BUILD_DIR)/layout.o $(BUILD_DIR)/layout_demo.o $(BUILD_DIR)/ui_button.o $(BUILD_DIR)/ui_label.o $(BUILD_DIR)/ui_panel.o $(BUILD_DIR)/ui_textinput.o $(BUILD_DIR)/ui_textarea.o $(BUILD_DIR)/ui_demo.o
