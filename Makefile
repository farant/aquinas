...
KERNEL_C_SRCS = $(KERNEL_DIR)/kernel.c $(KERNEL_DIR)/serial.c $(KERNEL_DIR)/vga.c $(KERNEL_DIR)/timer.c $(KERNEL_DIR)/rtc.c $(KERNEL_DIR)/memory.c $(KERNEL_DIR)/graphics.c $(KERNEL_DIR)/dispi.c $(KERNEL_DIR)/display_driver.c $(KERNEL_DIR)/pci.c

# Build files
BOOT_BIN = $(BUILD_DIR)/boot.bin
KERNEL_ENTRY_OBJ = $(BUILD_DIR)/kernel_entry.o
KERNEL_C_OBJS = $(BUILD_DIR)/kernel.o $(BUILD_DIR)/serial.o $(BUILD_DIR)/vga.o $(BUILD_DIR)/timer.o $(BUILD_DIR)/rtc.o $(BUILD_DIR)/memory.o $(BUILD_DIR)/graphics.o $(BUILD_DIR)/dispi.o $(BUILD_DIR)/display_driver.o $(BUILD_DIR)/pci.o
