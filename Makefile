...
KERNEL_C_SRCS = $(KERNEL_DIR)/kernel.c $(KERNEL_DIR)/serial.c $(KERNEL_DIR)/vga.c $(KERNEL_DIR)/timer.c $(KERNEL_DIR)/rtc.c $(KERNEL_DIR)/memory.c $(KERNEL_DIR)/graphics.c $(KERNEL_DIR)/dispi.c $(KERNEL_DIR)/display_driver.c $(KERNEL_DIR)/pci.c $(KERNEL_DIR)/dispi_cursor.c $(KERNEL_DIR)/grid.c $(KERNEL_DIR)/graphics_context.c $(KERNEL_DIR)/page.c $(KERNEL_DIR)/modes.c $(KERNEL_DIR)/display.c $(KERNEL_DIR)/commands.c $(KERNEL_DIR)/editor.c $(KERNEL_DIR)/input.c $(KERNEL_DIR)/mouse.c $(KERNEL_DIR)/dispi_init.c $(KERNEL_DIR)/dispi_demo.c $(KERNEL_DIR)/view.c $(KERNEL_DIR)/layout.c $(KERNEL_DIR)/layout_demo.c $(KERNEL_DIR)/ui_button.c $(KERNEL_DIR)/ui_label.c $(KERNEL_DIR)/ui_panel.c $(KERNEL_DIR)/ui_demo.c
